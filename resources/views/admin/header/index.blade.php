...
<div class="col-md-12 ml-auto mr-auto">
    <div class="card card-signup">
        <h2 class="card-title text-center">Index Header</h2>
        <div class="col-md-11 ml-auto mr-auto">
            <a href="{{ route('form-tambah.header') }}" type="button" class="btn btn-info mb-5">Input Profil
                Baru</a>
            <table id="example" class="display" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="{{ URL::asset($y->path) }}" width="100px" height="50px"></td>
                        <td class="td-actions text-right">
                            <a href="{{ route('form-edit.header', $y->id) }}" type="button" rel="tooltip"
                            ...
                            <form method="POST" action="{{route('delete.header', $y->id)}}" class="d-inline-block">
                                @csrf
                                @method('delete')
