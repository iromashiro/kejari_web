...
<div class="col-md-12 ml-auto mr-auto">
    <div class="card card-signup">
        <h2 class="card-title text-center">Index Menu Jabatan</h2>
        <div class="col-md-11 ml-auto mr-auto">
            <a href="{{ route('form-tambah.jabatan') }}" type="button" class="btn btn-info mb-5">Input Jabatan
                Baru</a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td-actions text-right">
                            <a href="{{ route('form-edit.jabatan', $y->id) }}" type="button" rel="tooltip"
                            ...
                            <form method="POST" action="{{route('delete.jabatan', $y->id)}}" class="d-inline-block">
                                @csrf
                                @method('delete')
