...
<div class="col-md-12 ml-auto mr-auto">
    <div class="card card-signup">
        <h2 class="card-title text-center">Index Produk Hukum</h2>
        <div class="col-md-11 ml-auto mr-auto">
            <a href="{{ route('form-tambah.produk-hukum') }}" type="button" class="btn btn-info mb-5">Input Produk
                Hukum
                Baru</a>
            <table id="example" class="display" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ env('APP_URL') }}{{ Storage::url($y->path) }}">Download</a></td>
                        <td>{{ $y->nama_produk }}</td>
