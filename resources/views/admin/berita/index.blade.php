...
<div class="col-md-12 ml-auto mr-auto">
    <div class="card card-signup">
        <h2 class="card-title text-center">Index Berita</h2>
        <div class="col-md-11 ml-auto mr-auto">
            <a href="{{ route('form-tambah.berita') }}" type="button" class="btn btn-info mb-5">Input Berita
                Baru</a>
            <table id="example" class="display" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $y->created_at }}</td>
                        <td>{{ $y->tags }}</td>
                        <td>{{ $y->jenis_aktifitas }}</td>
                        <td class="td-actions text-right">
                            <a href="{{ route('form-edit.berita', $y->id) }}" type="button" rel="tooltip"
