...
<div class="col-md-12 ml-auto mr-auto">
    <div class="card card-signup">
        ...
        <div class="col-md-11 ml-auto mr-auto">
            <form action="{{ route('edit.berita', $x->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('patch')
                <div class="col-md-12">
                    <div class="form-group has-default bmd-form-group">
                        <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                            <div class="fileinput-new thumbnail img-raised">
                                <img src="{{ URL::asset($x->thumbnail)}}" alt="...">
                            </div>
                ...
                <div class="col-md-12">
                    <div class="form-group has-default bmd-form-group">
                        <input type="text" class="form-control tagsinput" data-color="rose"
                            placeholder="Masukkan Tags Disini" name="tags" value="{{ $x->tags }}">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group has-default bmd-form-group">
