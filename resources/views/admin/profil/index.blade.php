...
<div class="col-md-12 ml-auto mr-auto">
    <div class="card card-signup">
        <h2 class="card-title text-center">Index Menu Profil</h2>
        <div class="col-md-11 ml-auto mr-auto">
            <a href="{{ route('form-tambah.profil') }}" type="button" class="btn btn-info mb-5">Input Profil
                Baru</a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td-actions text-right">
                            ...
                            <form method="POST" action="{{route('delete.profil', $y->id)}}" class="d-inline-block">
                                @csrf
                                @method('delete')
